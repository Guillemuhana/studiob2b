...
const PAGINAS = [
  {
    ...
    desc: "Tu web hoy es un folleto. La convertimos en un vendedor: atiende en segundos, califica cada consulta y te la entrega lista para llamar. Lista en 7 días. Solicitá tu demo gratis.",
